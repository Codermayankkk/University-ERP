<%-- 
    Document   : Faculty Atendance
    Created on : 12 Aug, 2023, 10:35:42 AM
...
<center>    
    <br></br>
    <h2 style="color: dodgerblue; text-align: center; margin: 0;">Select student section to upload student attendance</h2>
       <%if(rs.getString("sec_1").equalsIgnoreCase("none"))
        {
        ...
        {
        %><form action="Select Session.jsp">
          <label><%=rs.getString("sec_1")%></label>&nbsp&nbsp&nbsp&nbsp
          <button type="submit" name="branch" value="<%=rs.getString("sec_1")%>">Click here to upload attendance</button>
          </form><%    
        }
        %>
        ...
        {
        %><form action="Select Session.jsp">
          <label><%=rs.getString("sec_2")%></label>
          <button type="submit" name="branch" value="<%=rs.getString("sec_2")%>">Click here to upload attendance</button>
          </form><%    
        }
        %>
        ...
        {
        %><form action="Select Session.jsp">
          <label><%=rs.getString("sec_3")%></label>&nbsp&nbsp
          <button type="submit" name="branch" value="<%=rs.getString("sec_3")%>">Click here to upload attendance</button>
          </form><%    
        }
        %>
        ...
        {
        %><form action="Select Session.jsp">
          <label><%=rs.getString("sec_4")%></label>&nbsp&nbsp
          <button type="submit" name="branch" value="<%=rs.getString("sec_4")%>">Click here to upload attendance</button>
          </form><%    
        }
        %>
        ...
        {
        %><form action="Select Session.jsp">
          <label><%=rs.getString("sec_5")%></label>&nbsp&nbsp
          <button type="submit" name="branch" value="<%=rs.getString("sec_5")%>">Click here to upload attendance</button>
          </form><%    
        }
        %>    
</center> 
