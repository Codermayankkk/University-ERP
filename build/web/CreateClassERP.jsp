<%-- 
    Document   : CreateClassERP
    Created on : 22 Aug, 2023, 8:05:34 AM
...
<div class="navbar">
  ...
  <a href="logout.jsp" style="float:right;"><i class="fa-solid fa-power-off"></i>&nbsp;&nbsp;Logout</a>
        ...
        <br/>
        <h2 style="color: dodgerblue; text-align: center; margin: 0;">Update student attendance detail ERP for current semester</h2>
<%
          }
             }
            ...
            try
            {
              ...
              {
%>
<form action="InsertStudentAttendanceListChecker" method="POST">
      ...
      <div class="form-control">
          ...
          <button type="submit">Create <%=rs.getString("student_name")%> ERP for <%=sem%> attendance</button>
