<%-- 
    Document   : Select Marks Session
    Created on : 23 Aug, 2023, 11:53:15 AM
...
<center>
    <br></br><br></br>
    <h2 style="color: dodgerblue; text-align: center; margin: 0;">Choose your session for alloted branch</h2>
    <form action="SelectMarksSessionChecker" method="POST">
    <input type="hidden" name="username" value="<%=username%>">
    <input type="hidden" name="branch" value="<%=branch%>">
    
<%
   if(rs.getString("alloted_session1") == null)
   {
   ...
   {
%>
   <font style="font-weight: bold; font-family: sans-serif; color: dodgerblue;">Session &nbsp; <%=rs.getString("alloted_session1")%></font>&nbsp;&nbsp; 
   <input type="radio" name="Session" value="<%=rs.getString("alloted_session1")%>"><br></br>
<%       
   }
%>    
 
<%
   if(rs.getString("alloted_session2") == null)
   {
   ...
   {
%>
   <font style="font-weight: bold; font-family: sans-serif; color: dodgerblue;"><%=rs.getString("alloted_session2")%></font>&nbsp;&nbsp; 
   <input type="radio" name="Session" value="<%=rs.getString("alloted_session2")%>"><br></br>
<%       
   }
%>

<%
   if(rs.getString("alloted_session3") == null)
   {
   ...
   {
%>
   <font style="font-weight: bold; font-family: sans-serif; color: dodgerblue;">Session &nbsp;<%=rs.getString("alloted_session3")%></font>&nbsp;&nbsp; 
   <input type="radio" name="Session" value="<%=rs.getString("alloted_session3")%>"><br></br>
<%       
   }
%>

<%
   if(rs.getString("alloted_session4") == null)
   {
   ...
   {
%>
   <font style="font-weight: bold; font-family: sans-serif; color: dodgerblue;">Session &nbsp;<%=rs.getString("alloted_session4")%></font>&nbsp;&nbsp; 
   <input type="radio" name="Session" value="<%=rs.getString("alloted_session4")%>"><br></br>
<%       
   }
%>
  <br/>
