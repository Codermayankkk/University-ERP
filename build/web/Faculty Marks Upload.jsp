<%-- 
    Document   : Faculty Marks Upload
    Created on : 23 Aug, 2023, 11:09:38 AM
...
<center>    
    <br></br>
    <h2 style="color: dodgerblue; text-align: center; margin: 0;">Select student section to upload student marks</h2>
       <%if(rs.getString("sec_1").equalsIgnoreCase("none"))
        {
        ...
        {
        %><form action="Select Marks Session.jsp">
          <label><%=rs.getString("sec_1")%></label>&nbsp&nbsp&nbsp&nbsp
          <button type="submit" name="branch" value="<%=rs.getString("sec_1")%>">Click here to upload marks</button>
          </form><%    
        }
        %>
        ...
        %><form action="Select Marks Session.jsp">
          ...
          <button type="submit" name="branch" value="<%=rs.getString("sec_2")%>">Click here to upload marks</button>
          </form><%    
        }
        %>
        ...
        %><form action="Select Marks Session.jsp">
          ...
          <button type="submit" name="branch" value="<%=rs.getString("sec_3")%>">Click here to upload marks</button>
          </form><%    
        }
        %>
        ...
        %><form action="Select Marks Session.jsp">
          ...
          <button type="submit" name="branch" value="<%=rs.getString("sec_4")%>">Click here to upload marks</button>
          </form><%    
        }
        %>
        ...
        %><form action="Select Marks Session.jsp">
          ...
          <button type="submit" name="branch" value="<%=rs.getString("sec_5")%>">Click here to upload marks</button>
          </form><%    
        }
        %>    
</center> 
