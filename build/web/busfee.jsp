<%-- 
    Document   : busfee
    Created on : 25 Jul, 2023, 11:21:30 AM
...
button[type=submit] 
{
  ...
  cursor: pointer;
    ...
    <body>
          ...
          %>
          <div class="topnav">
                             <h1 class="active" style="color: white; text-align: center; ">Bus Fee</h1>
          </div>
   ...
   <label>1st Year :</label>&nbsp&nbsp&nbsp&nbsp
...
<form action="#">
   ...
   <label>3rd Year :</label>&nbsp&nbsp
   <button type="submit">Print&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa-solid fa-print"></i></button>
</form>
...
<form action="#">
   ...
   <label>4th Year :</label>&nbsp&nbsp
   <button type="submit">Print&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa-solid fa-print"></i></button>
</form>
