<%-- 
    Document   : Create Attendance ERP
    Created on : 17 Aug, 2023, 4:09:11 AM
...
<center> 
        ...
        <br></br>
        <form action="CreateAttendanceSenderChecker" method="POST">
          ...
          <br></br>
          <button type="submit">Click here to create ERP for alloted branch</button>
