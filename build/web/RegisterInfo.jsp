<%-- 
    ...
    Created on : 22 Jul, 2023, 9:50:15 AM
...
label
{
  ...
  color: dodgerblue;  
    ...
    <body>
        ...
        <form action="ERPregisterChecker" method="POST">
			...
			<label for="name" id="label-name">Semester</label>
                        ...
                        <textarea id="name" name="sem" rows="1" cols="50" required></textarea>
		</div>
                
                <div class="form-control">
			<label for="name" id="label-name">Section</label>

                        <textarea id="name" name="section" rows="1" cols="50" required></textarea>
		</div>         
			...
			<textarea id="branch" name="branch" rows="1" cols="50" required></textarea>
		</div>
                
                <div class="form-control">
			<label for="branch" id="label-branch">Session</label>

			<textarea id="branch" name="Session" rows="1" cols="50" required></textarea>
		</div>         
                         
                <div class="form-control">
			<label for="year" id="label-year">Year</label>

			<textarea id="year" name="year" rows="1" cols="50" required></textarea>
		</div>
