<%-- 
    Document   : Btech(Mtech)
    Created on : 10 Aug, 2023, 1:02:32 AM
    Author     : hp
--%>
<!DOCTYPE html>
     ...
     <body>   
         <%
            ...
            try
            {
              ...
              if(rs.next())
              {
                student_branch = rs.getString("sec_2");  
          %>
           <div class="navbar">
...
<%           }
          ...
          %>    
      <br></br>     
      <h2 style="color: dodgerblue; text-align: center; margin: 0;">Btech + Mtech</h2>     
