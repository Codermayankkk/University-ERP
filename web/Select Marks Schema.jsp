<%-- 
    Document   : Select Marks Schema
    Created on : 23 Aug, 2023, 12:05:40 PM
...
<div class="navbar">
  ...
  <a href="logout.jsp" style="float:right;"><i class="fa-solid fa-power-off"></i>&nbsp;&nbsp;Logout</a>
      ...
      <br></br>
      <h2 style="color: dodgerblue; text-align: center; margin: 0;">Choose your alloted schema</h2>
<%
     }
    }
    ...
    {
      Statement st = DBconnector.getStatement();
      String q = "SELECT * FROM AllSchema";
...
%>
<center>
   <form action="SelectMarksSchemaChecker" method="POST">
    <input type="hidden" name="username" value="<%=username%>">
    <input type="hidden" name="branch" value="<%=branch%>">
    
    <label><%=rs.getString("alluniversityschema")%></label> 
    <input type="radio" name="schema" value="<%=rs.getString("alluniversityschema")%>" style="display: inline;"><br/><br/>
