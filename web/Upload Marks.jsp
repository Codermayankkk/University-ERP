<%-- 
    ...
    Created on : 23 Aug, 2023, 11:51:54 AM
...
System.out.println(Session);
    ...
    {
      Statement st = DBconnector.getStatement();
      String q = "SELECT * FROM mk"+sem+" WHERE student_branch = '"+branch+"' && student_session = '"+Session+"'";
...
%>
<center>
   <form action="UploadMarksChecker" method="POST">
    ...
    `<label>Student Name : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="black" style="font-weight: lighter;"><%=rs.getString("student_name")%></font></label>
     ...
     <input type="text" name="marks" value="<%=rs.getString(""+subject+"_marks")%>"><br/>
     
     <label><%=subject%> ta :</label>
     <input type="text"  name="ta" value="<%=rs.getString(""+subject+"_ta")%>"><br/>
