<%-- 
    Document   : faculty homepage
    Created on : 8 Jul, 2023, 9:51:49 AM
...
<div class="navbar">
  ...
  <a href="logout.jsp" style="float:right;"><i class="fa-solid fa-power-off"></i>&nbsp;&nbsp;Logout</a>
     ...
     %>
        <center>
                <h1 style="color: dodgerblue; font-family: sans-serif; font-weight: bold;">Shri Vaishnav Vidhyapeeth Vishwavidyalya</h1>
                <br></br><br/>
                <img src = "images/<%=rs.getString("faculty_img")%>" alt = "image not found" height = 200 width = 200 />
                <br></br><br/>
                <label style="color: dodgerblue; font-family: sans-serif; font-weight: bold;">Name - </label>
                &nbsp;
                <label style="font-family: sans-serif; font-weight: bold;"><%=rs.getString("faculty_name")%></label>
                <br></br><br/>
                <label style="color: dodgerblue; font-family: sans-serif; font-weight: bold;">Faculty id - </label>
                &nbsp;
                <label style="font-family: sans-serif; font-weight: bold;"><%=rs.getString("faculty_id")%></label>
                <br></br><br/>
                <label style="color: dodgerblue; font-family: sans-serif; font-weight: bold;">Department - </label>
                &nbsp;
                <label style="font-family: sans-serif; font-weight: bold;"><%=rs.getString("faculty_dept")%></label>
         </center>
     <%         
          }    
        }    
