<%-- 
    Document   : Select Marks Subject
    Created on : 23 Aug, 2023, 11:32:42 AM
...
<div class="navbar">
  ...
  <a href="logout.jsp" style="float:right;"><i class="fa-solid fa-power-off"></i>&nbsp;&nbsp;Logout</a>
      ...
      <br></br>
      <h2 style="color: dodgerblue; text-align: center; margin: 0;">Choose your alloted subject</h2>
<%
     }
    }
    ...
    {
      Statement st = DBconnector.getStatement();
      String q = "SELECT * FROM "+schema+" WHERE Semester = '"+sem+"'";
...
%>
<center>
   <form action="SelectSubjectMarksChecker" method="POST">
    ...
    <%if(rs.getString("sub_1").equalsIgnoreCase("none"))
        {
            
        }
        else
        {
          %><label><%=rs.getString("sub_1")%></label> 
            <input type="radio" name="subject" value="<%=rs.getString("sub_1")%>"><br></br><%    
        }
        %>
        
     <%if(rs.getString("sub_2").equalsIgnoreCase("none"))
        {
            
        }
        else
        {
          %><label><%=rs.getString("sub_2")%></label> 
            <input type="radio" name="subject" value="<%=rs.getString("sub_2")%>"><br></br><%    
        }
        %>
     
     <%if(rs.getString("sub_3").equalsIgnoreCase("none"))
        {
            
        }
        else
        {
          %><label><%=rs.getString("sub_3")%></label> 
            <input type="radio" name="subject" value="<%=rs.getString("sub_3")%>"><br></br><%    
        }
        %>
   
        <%if(rs.getString("sub_4").equalsIgnoreCase("none"))
        {
            
        }
        else
        {
          %><label><%=rs.getString("sub_4")%></label> 
            <input type="radio" name="subject" value="<%=rs.getString("sub_4")%>"><br></br><%    
        }
        %>
        
        <%if(rs.getString("sub_5").equalsIgnoreCase("none"))
        {
            
        }
        else
        {
          %><label><%=rs.getString("sub_5")%></label> 
            <input type="radio" name="subject" value="<%=rs.getString("sub_5")%>"><br></br><%    
        }
        %>
   
        <%if(rs.getString("sub_6").equalsIgnoreCase("none"))
        {
            
        }
        else
        {
          %><label><%=rs.getString("sub_6")%></label> 
            <input type="radio" name="subject" value="<%=rs.getString("sub_6")%>"><br></br><%    
        }
        %>
   
        <%if(rs.getString("sub_7").equalsIgnoreCase("none"))
        {
            
        }
        else
        {
          %><label><%=rs.getString("sub_7")%></label> 
            <input type="radio" name="subject" value="<%=rs.getString("sub_7")%>"><br></br><%    
        }
        %>
