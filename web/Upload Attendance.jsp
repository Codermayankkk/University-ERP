<%-- 
    ...
    Created on : 16 Aug, 2023, 7:19:11 AM
...
<div class="navbar">
  ...
  <a href="logout.jsp" style="float:right;"><i class="fa-solid fa-power-off"></i>&nbsp;&nbsp;Logout</a>
      ...
      <br></br>
      <h2 style="color: dodgerblue; text-align: center; margin: 0;">Upload <%=subject%> attendance in branch <%=branch%></h2>
<%
     }
    }
...
System.out.println(Session);
    ...
    {
      Statement st = DBconnector.getStatement();
      String q = "SELECT * FROM at"+sem+" WHERE student_branch = '"+branch+"' && student_session = '"+Session+"'";
...
%>
<center>
   <form action="UploadAttendanceChecker" method="POST">
    ...
    `<label>Student Name : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="black" style="font-weight: lighter;"><%=rs.getString("student_name")%></font></label>
     <label>Enrollment id : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="black" style="font-weight: lighter;"><%=student_id%></font></label><br/>
     
     <label><%=subject%> attendance :</label>
     <input type="text" name="at" value="<%=rs.getString(""+subject+"_at")%>"><br/>
     
     <label><%=subject%> present class :</label>
     <input type="text"  name="pc" value="<%=rs.getString(""+subject+"_pc")%>"><br/>
     
     <label><%=subject%> absent class :</label>
     <input type="text" name="ac" value="<%=rs.getString(""+subject+"_ac")%>"><br/>
